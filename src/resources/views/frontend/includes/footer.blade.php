        ...
        <div class="row no-gutters">
            ...
            <div class="col-sm-6 col-lg-3">
                ...
                <a href="javascript:void(0)" class="download-app">
                    <div class="media">
                        <img src="{{ asset('frontend/') }}/img/app/google-play.svg" alt="Google Play Logo" height="30">
                ...
                <a href="javascript:void(0)" class="download-app">
                    <div class="media">
                        <img src="{{ asset('frontend/') }}/img/app/apple.svg" alt="Apple Logo" height="30">
                        <div class="media-body">
                ...
                <a href="javascript:void(0)" class="download-app">
                    <div class="media">
                        <img src="{{ asset('frontend/') }}/img/app/windows.svg" alt="Windows Logo" height="30">
                        <div class="media-body">
...
<div class="copyright">Copyright © 2021 OSP All right reserved</div>
<!-- /Footer -->
